...
export default function UnityPlayer() {
  ...
  const { unityProvider, isLoaded, requestFullscreen, sendMessage } =
    useUnityContext({
      loaderUrl: "/Builds/Build/Build 32-2.loader.js",
      dataUrl: "/Builds/Build/Build 32-2.data.unityweb",
      frameworkUrl: "/Builds/Build/Build 32-2.framework.js.unityweb",
      codeUrl: "/Builds/Build/Build 32-2.wasm.unityweb",
    });
