...
export default function UnityPlayer() {
  ...
  const { unityProvider, isLoaded, requestFullscreen, sendMessage } =
    useUnityContext({
      loaderUrl: "/Builds/Build/Build 27.loader.js",
      dataUrl: "/Builds/Build/Build 27.data.unityweb",
      frameworkUrl: "/Builds/Build/Build 27.framework.js.unityweb",
      codeUrl: "/Builds/Build/Build 27.wasm.unityweb",
    });
